...
import { Markdown, Plugin, ButtonView, ClassicEditor, WordCount } from "ckeditor5";
import { useState, useRef, useEffect } from "react";
import { CKEditor } from "@ckeditor/ckeditor5-react";
import { useIntl } from "react-intl";
import { Grid, Loader, Field, Flex } from "@strapi/design-system";
import "ckeditor5/ckeditor5-editor.css";
import "ckeditor5/ckeditor5.css";
import "ckeditor5/ckeditor5-content.css";
import { s as strapi } from "./index-Bx4iX12X.mjs";
...
const CKEditorInput = ({
  ...
  useEffect(() => {
    (async () => {
      try {
        const response = await fetch(`/ckeditor5/config/upload`);
        const uploadPluginConfig2 = await response.json();
        if (!uploadPluginConfig2.data) {
          return;
        }
        setUploadPluginConfig(uploadPluginConfig2.data);
      } catch (error2) {
        console.log(error2);
      }
    })();
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(
      Field.Root,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs(Flex, { spacing: 2, direction: "column", alignItems: "stretch", children: [
            /* @__PURE__ */ jsx(Field.Label, { action: labelAction, required, children: intlLabel && formatMessage(intlLabel) }),
            /* @__PURE__ */ jsx(
              CKEditor,
              {
            ...
            editorConfig.plugins.includes("WordCountPlugin") && /* @__PURE__ */ jsx(
              "div",
              {
            ...
            /* @__PURE__ */ jsx("div", { ref: wordCounter }),
...
//# sourceMappingURL=index-DpGyYr4y.mjs.map
