...
const strapi = {
  id: "ckeditor5",
  name: "strapi-plugin-ckeditor-v5",
...
const RegisterOptions = {
  ...
  components: {
    Input: async () => await import("./index-CKQjc3Sa.mjs").then((module) => ({ default: module.CKEditorInput }))
  },
  options: {
    base: [
      {
...
//# sourceMappingURL=index-Bm-w0I2p.mjs.map
