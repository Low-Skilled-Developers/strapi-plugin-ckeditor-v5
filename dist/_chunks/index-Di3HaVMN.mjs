...
const RegisterOptions = {
  ...
  components: {
    Input: async () => await import("./index-DjcJ1D5_.mjs").then((module) => ({ default: module.CKEditorInput }))
  },
  options: {
    base: [
      {
...
class CKEditorPlugin {
  ...
  registerTrads = async ({ locales }) => {
    const promises = locales.map(async (locale) => {
      try {
        const { default: data } = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => import("./en-CFuBvX3Q.mjs") }), `./translations/${locale}.json`);
        return {
          data,
          locale
        };
...
//# sourceMappingURL=index-Di3HaVMN.mjs.map
