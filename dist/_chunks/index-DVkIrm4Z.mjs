import require$$0$1a from "util";
import require$$0$19 from "os";
import require$$0$1b from "events";
import require$$2$p from "buffer";
import require$$10$2 from "string_decoder/";
import require$$0$1c from "fs";
import require$$1$L from "path";
import require$$3$j from "zlib";
import require$$1$K from "string_decoder";
import require$$0$1d from "http";
import require$$1$M from "https";
...
var inspect = require$$0$1a.inspect;
...
var common$2 = {};
(function(exports) {
  var _require4 = require$$0$1a, format2 = _require4.format;
  exports.warn = {
...
var streamBrowser = require$$0$1b.EventEmitter;
...
function requireBuffer_list() {
  ...
  var _require4 = require$$2$p, Buffer2 = _require4.Buffer;
  var _require22 = require$$0$1a, inspect2 = _require22.inspect;
...
function require_stream_readable() {
  ...
  require$$0$1b.EventEmitter;
  var EElistenerCount = function EElistenerCount2(emitter, type) {
    return emitter.listeners(type).length;
  };
  var Stream2 = require$$1$D;
  var Buffer2 = require$$2$p.Buffer;
  ...
  function ReadableState(options, stream2, isDuplex) {
    ...
    if (options.encoding) {
      if (!StringDecoder)
        StringDecoder = require$$10$2.StringDecoder;
...
(function(module, exports) {
  ...
  exports.Transform = require$$3$e;
  exports.PassThrough = require$$4$a;
  exports.finished = require$$5$6;
  exports.pipeline = require$$6$6;
...
function requireTailFile() {
  ...
  var fs = require$$0$1c;
  var _require4 = require$$1$K, StringDecoder = _require4.StringDecoder;
...
function requireFile() {
  ...
  var fs = require$$0$1c;
  var path = require$$1$L;
  var asyncSeries = requireSeries();
  var zlib = require$$3$j;
...
function requireHttp() {
  ...
  var http = require$$0$1d;
  var https = require$$1$M;
...
(function(exports) {
  ...
  exports.version = require$$2$k.version;
  exports.transports = require$$3$b;
  exports.config = require$$4$9;
  exports.addColors = logform2.levels;
  exports.format = logform2.format;
  exports.createLogger = require$$5$4;
  exports.Logger = require$$6$4;
  exports.ExceptionHandler = require$$7$3;
  exports.RejectionHandler = require$$8$2;
  exports.Container = require$$9$2;
  exports.Transport = require$$10;
...
const RegisterOptions = {
  ...
  type: strapi.type,
  icon: () => /* @__PURE__ */ jsx("img", { src: PluginIcon, style: { width: 24, height: 24 }, alt: "plugin image" }),
  intlLabel: {
  ...
  components: {
    Input: () => import("./index-BQF0dt5W.mjs").then((module) => ({ default: module.CKEditorInput }))
  },
  options: {
    base: [
      {
...
class CKEditorPlugin {
  ...
  registerTrads = async ({ locales }) => {
    const promises = locales.map(async (locale) => {
      try {
        const { default: data } = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => import("./en-D5x4uMJ_.mjs") }), `./translations/${locale}.json`);
        return {
          data,
          locale
        };
...
//# sourceMappingURL=index-DVkIrm4Z.mjs.map
