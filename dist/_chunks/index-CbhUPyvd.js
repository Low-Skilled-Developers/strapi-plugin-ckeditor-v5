...
const RegisterOptions = {
  ...
  components: {
    Input: async () => await Promise.resolve().then(() => require("./index-DKdj2ObD.js")).then((module2) => ({ default: module2.CKEditorInput }))
  },
  options: {
    base: [
      {
...
class CKEditorPlugin {
  ...
  registerTrads = async ({ locales }) => {
    const promises = locales.map(async (locale) => {
      try {
        const { default: data } = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => Promise.resolve().then(() => require("./en-BtGH7Sxw.js")) }), `./translations/${locale}.json`);
        return {
          data,
          locale
        };
...
//# sourceMappingURL=index-CbhUPyvd.js.map
