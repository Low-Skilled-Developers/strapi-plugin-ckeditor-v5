...
const strapi = {
  id: "ckeditor5",
  name: "plugin:strapi-plugin-ckeditor-v5",
...
const RegisterOptions = {
  ...
  components: {
    Input: async () => await import("./index-DqzGYV6X.mjs").then((module) => ({ default: module.CKEditorInput }))
  },
  options: {
    base: [
      {
...
class CKEditorPlugin {
  ...
  registerTrads = async ({ locales }) => {
    const promises = locales.map(async (locale) => {
      try {
        const { default: data } = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => import("./en-CcQ6Y20G.mjs") }), `./translations/${locale}.json`);
        return {
          data,
          locale
        };
...
//# sourceMappingURL=index-C_wiFoPa.mjs.map
